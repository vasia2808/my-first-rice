...
sudo pacman -Syu --needed alacritty fastfetch firefox ffmpegthumbnailer gvfs-mtp grim hypridle hyprland hyprlock hyprpaper hyprpolkitagent mako neovim otf-font-awesome paru pipewire-jack pipewire-pulse playerctl pwvucontrol qimgv ranger rofi-wayland thunar tumbler ttf-jetbrains-mono-nerd ttf-nerd-fonts-symbols waybar wl-clipboard wl-clip-persist xdg-desktop-portal-hyprland zsh
