...
sudo pacman -Syu --needed --noconfirm alacritty fastfetch firefox ffmpegthumbnailer gvfs-mtp grim hypridle hyprland hyprlock hyprpaper mako neovim noto-fonts-cjk otf-font-awesome paru pipewire-jack pipewire-pulse playerctl polkit-gnome pwvucontrol qimgv ranger rofi-wayland thunar tumbler ttf-jetbrains-mono-nerd waybar wl-clipboard wl-clip-persist xdg-desktop-portal-hyprland zsh
